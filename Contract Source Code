...
contract Safetokoomoon {

	uint256 constant private FLOAT_SCALAR = 2**64;
	uint256 constant private INITIAL_SUPPLY = 1000000000000000e18; // 
	uint256 constant private STAKE_FEE = 2; // 2% per tx
	uint256 constant private MIN_STAKE_AMOUNT = 1e19; // 10

	string constant public name = "Safetokoomoon";
	string constant public symbol = "STM";
